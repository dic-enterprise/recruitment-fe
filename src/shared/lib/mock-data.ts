...
export const departments: Department[] = [
  {
    ...
    contacts: [{ name: 'Trần Thị Lan', email: 'lan.tran@company.com', phone: '0901234567' }],
    jobCount: 3,
  },
  {
    id: 'dept-2',
    ...
    contacts: [{ name: 'Phạm Hồng Nhung', email: 'nhung.pham@company.com' }],
    jobCount: 2,
  },
  {
    id: 'dept-3',
    ...
    manager: 'Vũ Thị Mai',
    contacts: [{ name: 'Đỗ Quang Huy', email: 'huy.do@company.com', phone: '0912345678' }],
    jobCount: 1,
  },
  {
    id: 'dept-4',
    ...
    contacts: [{ name: 'Bùi Thanh Hà', email: 'ha.bui@company.com' }],
    jobCount: 1,
  },
];
...
const jobsSeed: Job[] = [
  {
    ...
    salary: '25-40M VND',
    requirements:
      '5+ years React/TypeScript experience. Strong understanding of modern frontend architecture, testing, and performance optimization.',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    salary: '20-35M VND',
    requirements: '3+ years Java/Spring Boot. Experience with microservices, PostgreSQL, and cloud platforms.',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    salary: '30-45M VND',
    requirements: 'Kubernetes, Docker, CI/CD pipelines, AWS/GCP. Infrastructure as Code.',
    status: 'CLOSED',
  ...
  },
  {
    ...
    salary: '10-18M VND',
    requirements: 'Strong writing skills in Vietnamese and English. Experience with content strategy.',
    status: 'ARCHIVED',
  ...
  },
  {
    ...
    title: 'HR Generalist',
    salary: '18-28M VND',
    requirements: '3+ years HR experience. Knowledge of Vietnamese labor law.',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    salary: '20-32M VND',
    requirements: 'CFA preferred. Financial modeling, Excel, data analysis.',
    status: 'ACTIVE',
...
export const candidates: Candidate[] = [
  {
    ...
    phone: '0901111111',
    cvFileName: 'NguyenMinhDuc_CV.pdf',
  ...
  },
  {
    ...
    phone: '0902222222',
    cvFileName: 'TranThiHuong_CV.pdf',
    extractStatus: 'COMPLETE',
    employmentTag: 'CHUA_NHAN_VIEC',
  ...
  },
  {
    ...
    cvFileName: 'LeQuangHai_CV.docx',
    extractStatus: 'COMPLETE',
    employmentTag: 'DA_CO_VIEC',
  ...
  },
  {
    ...
    extractError: {
      code: 'AI_TIMEOUT',
      message:
        'AI provider timed out after 3 retries. The CV file may be too large or the provider is temporarily unavailable. Please contact Admin IT for retry.',
    },
  },
  {
    id: 'cand-7',
    name: 'Đặng Minh Tú',
    email: 'tu.dang@gmail.com',
    cvFileName: 'DangMinhTu_CV.pdf',
    extractStatus: 'COMPLETE',
    employmentTag: 'CHUA_NHAN_VIEC',
    uploadedAt: '2024-02-01',
    skills: ['Marketing', 'Google Ads', 'SEO', 'Content Strategy'],
    experience: '3 years digital marketing',
  },
  {
    id: 'cand-8',
    name: 'Bùi Thanh Sơn',
    email: 'son.bui@gmail.com',
    phone: '0908888888',
    cvFileName: 'BuiThanhSon_CV.pdf',
    extractStatus: 'COMPLETE',
    employmentTag: 'CHUA_NHAN_VIEC',
  ...
  },
  {
    ...
    extractError: {
      code: 'PARSE_ERROR',
      message:
        'Unable to parse CV content. The file may be corrupted or in an unsupported format. Please re-upload a valid PDF or DOCX file.',
    },
  },
  {
    id: 'cand-10',
    ...
    phone: '0900000010',
    cvFileName: 'TrinhVanKhoa_CV.pdf',
    extractStatus: 'COMPLETE',
    employmentTag: 'CHUA_NHAN_VIEC',
    uploadedAt: '2024-01-25',
    skills: ['Java', 'Kubernetes', 'AWS', 'Terraform'],
    experience: '7 years backend/devops',
  },
];
